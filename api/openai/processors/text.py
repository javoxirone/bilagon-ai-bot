...
class TextProcessor(OpenAIAPIBase):
    ...
    def generate_chat_response(self, messages: any, model: str = "gpt-4o-mini", temperature: float = 0.7, max_tokens: int = 500, stream: bool = False, stop: None | bool = None, **kwargs):
        try:
            return self.request(
                endpoint="chat",
                model=model,
