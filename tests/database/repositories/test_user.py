...
class TestUser:
    def setup_method(self):
        ...
        self.raw_user_list = [self.raw_user_data, ]
        self.serialized_user_list = [self.serialized_user_data, ]
    ...
    def test_serialize_raises_value_error_for_invalid_data(self):
        with pytest.raises(ValueError):
            self.db._serialize((None,))

    def test_get_raw_user_list_successful(self):
    ...
    def test_get_raw_user_list_raises_no_records_found(self):
    ...
    def test_get_serialized_user_list_successful(self):
    ...
    def test_get_serialized_user_list_no_records(self):
    ...
    def test_get_raw_user_successful(self):
    ...
    def test_get_raw_user_raises_no_records_found(self):
    ...
    def test_get_serialized_user_successful(self):
    ...
    def test_get_serialized_user_not_found(self):
    ...
    def test_add_user_integrity_error(self):
        mocked_cursor = self._setup_mock_cursor(method_name="execute")
        mocked_cursor.side_effect = IntegrityError()
        with pytest.raises(UserAlreadyExistsError):
            self.db.add_user(self.telegram_id, "javoxirone", "Javohir", "Nurmatjonov", "en")

    def test_add_user_data_error(self):
        mocked_cursor = self._setup_mock_cursor(method_name="execute")
        mocked_cursor.side_effect = DataError()
        with pytest.raises(DataTypeError):
            self.db.add_user(self.telegram_id, "javoxirone", "Javohir", "Nurmatjonov", "en")

    def test_user_exists_successful(self):
    ...
    def test_user_exists_data_error(self):
    ...
    def test_update_user_language_successful(self):
    ...
    def test_update_user_language_user_does_not_exist(self):
        self.db.user_exists = Mock(return_value=False)
        with pytest.raises(UserDoesNotExist):
            self.db.update_user_language(self.telegram_id, "uz")
        self.db.user_exists.assert_called_once_with(self.telegram_id)

    def test_update_user_language_data_error(self):
        self.db.user_exists = Mock(return_value=True)
        mocked_cursor = self._setup_mock_cursor(method_name="execute")
        mocked_cursor.side_effect = DataError()
        with pytest.raises(DataTypeError):
